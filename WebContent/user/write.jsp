		...
		<div class="container-fluid">
			...
			<div class="input-group">
				<span class="input-group-addon" id="sizing-addon2">文章标题</span> <input
					id="title" type="text" class="form-control" placeholder="请输入文章标题"
			...
			<div class="input-group">
				<span class="input-group-addon" id="sizing-addon2">文章简介</span> <input
					...
					placeholder="请输入文章简介" aria-describedby="sizing-addon2">
			</div>
			<br> 请选择文章分类：
			<div class="btn-group">
			...
			<button id="publish" class="btn btn-danger" style="float: right;">发表文章</button>
		</div>

		<div class="jumbotron" style="width: 50%; float: left;">
			<textarea id="textInp" placeholder="请在此输入内容，支持HTML5编辑，支持markdown语法，不支持脚本语言！！！"
				maxlength="10000" rows="30" cols="50" style="width: 100%;">
### 请在此输入内容，支持HTML5编辑，支持markdown语法，不支持脚本语言！！！
# 一级标题
## 二级标题
##### 五级标题
- 列表第一项
		...
		$("#publish").click(function () {
			...
			if( title==null || title=="" || content==null || content=="" || desc=="" || desc==null ){
				...
				$.post("../contentsServlet",{
					...
					if( data>0 ){
						//alert("发表文章成功！");
						if (confirm("发表文章成功! 是否继续创作? 若取消将跳转到您的个人博客中心!")) {
							location.reload();	//确定继续创作,刷新该页面
						} else {
