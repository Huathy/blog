...
<body>
		...
		<div class="menu">
			<c:forEach var="type" items="${types }" varStatus="status">
				<c:if test="${status.index==0 }">
					<a href="doIndex.jsp" class="focus">首页</a>
				</c:if>
				<c:if test="${status.index!=0 }">
	...
	<div class="mainLeft">
		<div class="main-content">
			<c:forEach var="content" items="${SerchContent }"  varStatus="status">
				<div class="listBox">
					<h1>${content.title }</h1>
					<p class="colDefault">
		...
		<c:if test="${not empty user }">
			<div class="rightBox" id="userInfo">
				...
				<p>
					...
					<a href="user/write.jsp">写博客</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="user/myAticle.jsp">我的博客</a>
				</p>
				<p>
	...
	<script>
		...
		$("#logout").click(function() {
			var resflag = false;	//恢复默认验证通过的状态为否
