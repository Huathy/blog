...
<body>
	...
	<div class="container-fluid">
		<div class="jumbotron">
			...
			<table class="table table-striped table-hover">
				...
				<c:forEach var="cont" items="${contents }" begin="${contBegin }"  end="${contBegin+9 }" varStatus="status">
					<!-- 存一下tname -->
	...
	<nav aria-label="Page navigation"
		...
		<ul class="pagination">
			...
			<%
				int counts = (int) request.getSession().getAttribute("counts");	//获取首页内容条数
			...
			<%
				...
				System.out.print( request.getSession().getAttribute("contents") );
			%>
